<template>
  <div class="background"></div>
    <Home />
  <footer>
    <span>© 2026 Made By <a href="/" target="_blank">{{ userName }}</a> | 本站由<a target="_blank" href="https://cloud.baidu.com/product/cdn.html">百度云CDN</a>提供加速 | </span>
    <!--、<a target="_blank" href="https://www.aliyun.com/product/cdn">阿里云CDN</a>-->
